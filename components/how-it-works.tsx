...
const steps = [
  {
    ...
    body: "Choose your visa type, travel dates and nationality. The whole form takes about three minutes to complete.",
  },
  {
    icon: CreditCard,
    title: "Upload & pay securely",
    body: "Add your passport and photo, then pay through our secure checkout. No hidden fees, ever.",
  },
  {
    icon: Send,
    title: "We process your visa",
    body: "Our team reviews every application by hand and submits it directly to UAE immigration on your behalf.",
  },
  {
    icon: PlaneTakeoff,
